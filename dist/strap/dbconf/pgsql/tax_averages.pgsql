...
Database  tax_averages  COLUMN_DEF     "tax_average_id=INTEGER PRIMARY KEY NOT NULL"
...
Database  tax_averages  POSTCREATE     "CREATE UNIQUE INDEX unq_tax_averages_state_country ON tax_averages (state, country)"
