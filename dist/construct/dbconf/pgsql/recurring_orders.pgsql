Database  recurring_orders  recurring_orders.txt __SQLDSN__
#ifdef SQLUSER
Database  recurring_orders  USER         __SQLUSER__
#endif
#ifdef SQLPASS
...
Database  recurring_orders  COLUMN_DEF   "pay_method=text"
Database  recurring_orders  COLUMN_DEF   "freq=text"
Database  recurring_orders  COLUMN_DEF   "day=text"
Database  recurring_orders  COLUMN_DEF   "day_date=text"
