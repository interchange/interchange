...
Document version: $Id: mvfaq.pod,v 1.3.4.2 2000-10-15 12:18:32 racke Exp $
...
=head2 Can I internationalize a store?

Yes, to the limit of your concentration. 8-)
...
You can use the standard POSIX currency localization:

	Locale fr_FR  currency_symbol     ff
	Locale fr_FR  cs_precedes         0
...
The locale can be set in the page:

	[setlocale locale=fr_FR persist=1]

Or as a side-effect from a URL:

	[page process/locale/fr_FR/page/index]En Francais[/page]
...
Interchange has one of the most complete and flexible shipping calculators
...
$Log: mvfaq.pod,v $
Revision 1.3.4.2  2000-10-15 12:18:32  racke
changes from main trunk merged in

Revision 1.5  2000/10/14 16:50:25  heins
Minor changes to remove wrong 3.x stuff in mvdocs.pod.

Added Internationalization FAQ.

Revision 1.4  2000/10/12 21:02:08  zarko
fixed pod errors
