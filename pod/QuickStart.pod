...
=head2 What happened to Minivend and Tallyman?
...
=head1 Demo Store Install Walkthrough
...
=head2 Show off demo store

Some day we will expand this section.

=head1 The adminstrative side
...
=head2 Table import/export

Tables can be imported into or experted from the minivend
...
=head1 Interesting files

    minivend.cfg
    catalog.cfg

=head1 In future versions of this document:

where everything went
What's going on underneath the hood?
Anatomy of a catalog
Anatomy of a minivend page
