#!/usr/bin/perl
#
# $Id: Order.pm,v 1.14.4.3 2000-11-05 13:00:38 racke Exp $
#
...
$VERSION = substr(q$Revision: 1.14.4.3 $, 10);
...
sub _de_postcode {
	my($ref,$var,$val) = @_;
	defined $val and $val =~ /^\s*\d{5}\s*$/
		and return (1, $var, '');
	return (undef, $var, 'not a German zip code');
}
