...
#
# $Id: Config.pm,v 1.23.2.8 2000-11-27 19:34:06 zarko Exp $
#
...
$VERSION = substr(q$Revision: 1.23.2.8 $, 10);
...
# END LDAP
		...
		if($d->{'type'} eq '8') {
			...
			$d->{Class} = $Global::Default_database;
		}
